...
namespace constantes {
	const char* NombresArchivos::archivoDirectorios = "/home/lucia/indice/directorios.dat";
	const char* NombresArchivos::archivoPunteros = "/home/lucia/indice/punteros.dat";
